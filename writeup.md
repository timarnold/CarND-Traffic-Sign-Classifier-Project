...
Results from my classifier acting on the images can be seen in the IPython notebook under the heading "Predict the Sign Type for Each Image". Additionally, the top 8 classifications for each image can be seen in the figure below.
